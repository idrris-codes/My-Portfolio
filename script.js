const translations = {
  ru: {
    ...
    data: {
      ...
      websites: [
        { title: "Elon Musk Digital Resume", type: "RESUME", status: "LIVE", desc: "Кинематичный сайт-резюме: биография, компании, карьера, премиальный тёмный дизайн и адаптация.", tags: ["Resume", "Cinematic", "Adaptive"], button: "Смотреть проект", link: "https://visitepage-production.up.railway.app/" },
        ...
        { title: "Elon Musk Portfolio", type: "PORTFOLIO", status: "LIVE", desc: "Рабочий сайт-портфолио Илона Маска: современная презентация личности, проектов, компаний и достижений в премиальном стиле.", tags: ["Portfolio", "Elon Musk", "Premium"], button: "Смотреть проект", link: "https://visitepage-production.up.railway.app/" }
      ]
    }
  },
  en: {
    ...
    data: {
      ...
      websites: [
        { title: "Elon Musk Digital Resume", type: "RESUME", status: "LIVE", desc: "A cinematic resume website: biography, companies, career, premium dark design and responsive layout.", tags: ["Resume", "Cinematic", "Adaptive"], button: "View project", link: "https://visitepage-production.up.railway.app/" },
        ...
        { title: "Elon Musk Portfolio", type: "PORTFOLIO", status: "LIVE", desc: "A working Elon Musk portfolio website: a modern presentation of his personality, projects, companies and achievements in a premium style.", tags: ["Portfolio", "Elon Musk", "Premium"], button: "View project", link: "https://visitepage-production.up.railway.app/" }
      ]
    }
  },
  tj: {
    ...
    data: {
      ...
      websites: [
        { title: "Elon Musk Digital Resume", type: "RESUME", status: "LIVE", desc: "Сайти резюмеи кинематикӣ: биография, ширкатҳо, карера, дизайни торики премиум ва мутобиқшавӣ.", tags: ["Resume", "Cinematic", "Adaptive"], button: "Дидани лоиҳа", link: "https://visitepage-production.up.railway.app/" },
        ...
        { title: "Elon Musk Portfolio", type: "PORTFOLIO", status: "LIVE", desc: "Сайти портфолиои кории Илон Маск: муаррифии муосири шахсият, лоиҳаҳо, ширкатҳо ва дастовардҳо бо услуби премиум.", tags: ["Portfolio", "Elon Musk", "Premium"], button: "Дидани лоиҳа", link: "https://visitepage-production.up.railway.app/" }
      ]
    }
  }
};
